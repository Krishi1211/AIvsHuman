...
This repository contains the final reproducible pipeline for studying AI-like code signals in open-source software using a calibrated GPTSniffer-style detector.
...
- `GPTSniffer/`
  - Reference GPTSniffer codebase kept for context.
...
- `GPTSniffer/` is kept as reference context, but the final implemented detector for this project is the one under `research_pipeline/gptsniffer_detector.py`.
